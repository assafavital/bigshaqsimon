...
public class ButtonGridView extends View implements SimonClone.Listener {
	...
	private static final int BUTTON_GRID_SIZE = 4;
	...
	private Bitmap skra_on, skra_off;
	...
	private void initDrawingInstruments() {
		...
		skra_on = BitmapFactory.decodeResource(resources, R.drawable.skra_on);
		skra_off = BitmapFactory.decodeResource(resources, R.drawable.skra_off);
	}	
	...
	private Bitmap getBitmapForButton(int row, int col) {
		...
		return pressed ? skra_on : skra_off;
//		switch (butnum) {
//		case 0:
//			return pressed ?
